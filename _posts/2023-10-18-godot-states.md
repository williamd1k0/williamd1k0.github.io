...
{% include figure.html type='iframe' src='/assets/game/state-clicker/StateClicker.html' title='A clicker game is a really good example, because it\'s basically state management on steroids.' width='576' height='324' %}
